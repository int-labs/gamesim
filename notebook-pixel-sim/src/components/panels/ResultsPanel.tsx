    ...
    <div className="flex flex-col gap-3">
      ...
      {tab === 'evaluation' && (
        <PixelPanel title="Phase Evaluations">
            ...
            <div className="flex flex-col gap-1.5">
              {evals.map((e, i) => (
                <div key={i} className="flex items-center justify-between bg-cream-50 border-2 border-ink-900 px-3 py-2">
                  <span className="font-hud text-[11px] uppercase">Phase {e.phase}</span>
                  <span className="text-[13px] text-ink-800">Day {e.day}</span>
          ...
          <div className="mt-3 text-[13px] text-ink-700 leading-snug">
        ...
        <PixelPanel title="Score Summary">
          {score ? (
            <div className="text-center">
              <div className="font-hud text-[10px] uppercase text-ink-700">Final Score</div>
              <div className="font-hud text-[40px] leading-none mt-1">
                {score.total}<span className="text-[18px] text-ink-700">/100</span>
              </div>
            ...
            <div className="text-[14px] text-ink-900 leading-relaxed">
              ...
              <ul className="list-disc pl-5 mt-2 text-[13px] text-ink-800 space-y-1">
