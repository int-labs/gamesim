      ...
      {pulse && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-20 left-1/2 -translate-x-1/2 px-4 py-2 bg-ink-900 border-2 border-warn shadow-pixel-3 font-hud text-[14px] uppercase text-cream-50 tracking-wider"
          >
            Day {pulse.day}
          </motion.div>
        </motion.div>
