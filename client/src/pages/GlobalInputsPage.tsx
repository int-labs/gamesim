...
const BLANK_CONTAINER = { category: "", key: "", label: "", description: "", maxSelections: "" };
const BLANK_ITEM = {
        ...
        <>
          ...
          <table>
            <tbody>
              ...
              <tr><td>Max Selections</td><td><input type="number" value={containerForm.maxSelections} onChange={e => setContainerForm(f => ({ ...f, maxSelections: e.target.value }))} /></td></tr>
            </tbody>
          </table>
          ...
          <table border={1} cellPadding={4}>
            <thead>
              <tr><th>_id</th><th>category</th><th>key</th><th>label</th><th>maxSelections</th><th># items</th><th>actions</th></tr>
            </thead>
            <tbody>
        ...
        <div style={{ border: "1px solid #ccc", padding: 8, marginTop: 12 }}>
          ...
          <table>
            <tbody>
              ...
              <tr><td>Type</td><td><input placeholder="(optional)" value={itemForm.type} onChange={e => setItemForm(f => ({ ...f, type: e.target.value }))} /></td></tr>
